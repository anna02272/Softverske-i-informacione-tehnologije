...
public class PanelGrafik extends JPanel implements Observer {
	...
	public void updatePerformed(UpdateEvent e) {
		// poziv metode pretka za ponovno iscrtavanje komponente. Ona poziva metodu
		// paintComponent.
	...
	/**
	 * paintComponent - metoda koju treba redefinisati kada želimo da promenimo
	 * način iscrtavanja komponente
	 */
	@Override
