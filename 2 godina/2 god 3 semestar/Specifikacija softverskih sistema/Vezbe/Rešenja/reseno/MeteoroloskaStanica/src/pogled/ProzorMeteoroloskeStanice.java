...
public class ProzorMeteoroloskeStanice extends JDialog implements Observer {
	...
	public void dodajKomponente() {
		...
		if (dnevnaTemperatura.getIzmereneVrednosti().size() != 0) {
			prikaziStatistiku();
		}
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				kontrolerStanice.dodajMerenje(dnevnaTemperatura);
			}
		});
	}
	...
	public void unosTemperature() {
		try {
			kontrolerStanice.unosNoveTemperature(tfUnosTemperature.getText(), this.dnevnaTemperatura);
			...
			JOptionPane.showMessageDialog(this, "Temperatura mora biti uneta kao broj!", "Greška",
