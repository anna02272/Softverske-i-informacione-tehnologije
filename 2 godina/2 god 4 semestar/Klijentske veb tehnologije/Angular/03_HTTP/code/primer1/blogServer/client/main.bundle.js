...
var appRoutes = [
    ...
    { path: 'entry/:id', component: __WEBPACK_IMPORTED_MODULE_14__pages_blog_entry_page_blog_entry_page_component__["a" /* BlogEntryPageComponent */] },
    { path: '',
        redirectTo: 'main',
        pathMatch: 'full'
    },
...
var BlogEntryListComponent = (function () {
    function BlogEntryListComponent(sharedBlogEntryService, router) {
...
var BlogEntryDetailsComponent = (function (_super) {
    ...
    function BlogEntryDetailsComponent(blogEntryService, commentService, route) {
...
var MainPageComponent = (function () {
    function MainPageComponent(blogEntryService) {
...
var BlogEntryService = (function () {
    ...
    BlogEntryService.prototype.filter = function (entryText) {
        var params = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpParams */]().set('entry', entryText);
