...
var appRoutes = [
    ...
    { path: 'entry/:id',
        component: __WEBPACK_IMPORTED_MODULE_14__pages_blog_entry_page_blog_entry_page_component__["a" /* BlogEntryPageComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_24__services_can_activate_auth_guard__["a" /* CanActivateAuthGuard */]] },
