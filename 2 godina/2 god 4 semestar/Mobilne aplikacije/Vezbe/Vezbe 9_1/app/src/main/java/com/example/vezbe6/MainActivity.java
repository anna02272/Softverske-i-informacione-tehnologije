...
import com.example.vezbe6.model.NavItem;
import com.example.vezbe6.activities.ReviewerPreferenceActivity;
import com.example.vezbe6.adapters.DrawerListAdapter;
import com.example.vezbe6.fragments.MyFragment;
import com.example.vezbe6.receivers.SyncReceiver;
import com.example.vezbe6.services.SyncService;
import com.example.vezbe6.tools.FragmentTransition;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_insert:
                Util.insert(MainActivity.this);
                finish();
                startActivity(getIntent());
                return true;
            case R.id.action_update:
                Util.update(MainActivity.this);
                finish();
                startActivity(getIntent());
                return true;
            case R.id.action_delete:
                Util.delete(MainActivity.this);
                finish();
                startActivity(getIntent());
                return true;
        }
