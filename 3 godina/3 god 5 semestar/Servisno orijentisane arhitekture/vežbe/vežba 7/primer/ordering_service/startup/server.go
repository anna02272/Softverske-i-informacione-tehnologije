...
import (
	...
	handlers2 "github.com/tamararankovic/microservices_demo/ordering_service/handlers"
...
func (server *Server) startGrpcServer(orderHandler *handlers2.OrderHandler) {
